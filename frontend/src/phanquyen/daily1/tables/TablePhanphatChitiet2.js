...
import { headCellsPhanphatChitiet2 } from "./headCells";
import img_placeholder from "../../../assets/images/img_placeholder.png";

const TablePhanphatChitiet2 = ({
  dsVattu = [],
  singlePhanphat,
  setVattu,
  handleOpenModal,
  ...
  const handleClickTableCell = (vattuObj) => {
    setVattu(vattuObj);
    handleOpenModal();
  };
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              headCells={headCellsPhanphatChitiet2}
            />
            <TableBody>
              {dsVattu
                .slice()
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell
                        align="right"
                        onClick={() => handleClickTableCell(row.vattu)}
                      >
                        <Link to="#">{row.vattu.ten}</Link>
                      </TableCell>
