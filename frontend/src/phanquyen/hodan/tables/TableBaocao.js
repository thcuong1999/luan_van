...
import { headCellsBaocao } from "./headCells";
...
const TableBaocao = ({ dsBaocao = [], tiendoId }) => {
  ...
  const onClickCapnhat = () =>
    history.push(
      `/hodan/tiendo/chitiet/${tiendoId}/baocao/chinhsua/${selected[0]}`
    );
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <Link
                            to={`/hodan/tiendo/chitiet/${tiendoId}/baocao/chitiet/${row._id}`}
                          >
                            {row.ten}
                          </Link>
                        </TableCell>
