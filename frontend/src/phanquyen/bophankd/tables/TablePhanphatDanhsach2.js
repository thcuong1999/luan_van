...
import { headCellsVattuPhanphat } from "./headCells";
...
const TablePhanphatDanhsach2 = ({ dsPhanphat = [] }) => {
        ...
        <TableContainer>
          ...
          >
            <EnhancedTableHead
              ...
              headCells={headCellsVattuPhanphat}
            />
            <TableBody>
              {dsPhanphat
                .slice()
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Link
                          to={`/bophankd/vattuphanphat/chitiet/${row.phanphat?._id}`}
                        >
                          <VisibilityIcon />
                        </Link>
                      </TableCell>
...
export default TablePhanphatDanhsach2;
