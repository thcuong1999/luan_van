...
import { headCellsSanphamThem } from "./headCells";
        ...
        {numSelected > 0 && (
          <Tooltip title="Delete">
            <IconButton>
              <ButtonMaterial
                variant="contained"
                onClick={() => handleThemSanpham(rowsSelected)}
              >
                Thêm sản phẩm
              </ButtonMaterial>
            </IconButton>
...
const TableSanphamThem = ({ dsSanpham = [], handleThemSanpham }) => {
          ...
          <TableContainer>
            ...
            >
              <EnhancedTableHead
                ...
                headCells={headCellsSanphamThem}
              />
              <TableBody>
                {dsSanpham
                  .slice()
...
export default TableSanphamThem;
