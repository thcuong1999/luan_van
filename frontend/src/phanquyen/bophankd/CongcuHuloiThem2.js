...
const CongcuHuloiThem2 = (props) => {
  ...
  const submitForm = async () => {
    if (!emptyField()) {
      ...
      formData.append("soluongloi", soluongLoi);
    ...
    <>
      <Container>
        ...
        <Content>
          <Form>
            <FormContent>
              <FormTitle>Thêm công cụ lỗi</FormTitle>
              <FormGroup>
              ...
              <FormGroup>
                ...
                <Input
                  type="text"
                  placeholder="Nhập số lượng lỗi hiện hành"
                  onChange={(e) => {
                    ...
                    if (isNaN(val)) {
                      ...
                      setSoluongLoi(e.target.value);
                    }
                  }}
                />
                {!soluongLoi && <ErrMsg>{errMsg}</ErrMsg>}
              </FormGroup>
...
export default CongcuHuloiThem2;
