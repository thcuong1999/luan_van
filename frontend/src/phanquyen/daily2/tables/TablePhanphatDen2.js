...
import { headCellsPhanphat2 } from "./headCells";
import VisibilityIcon from "@mui/icons-material/Visibility";

const TablePhanphatDen2 = ({ dsPhanphat = [] }) => {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">
                        <Link
                          to={`/daily2/vattuphanphat/chitiet/${row.phanphat?._id}`}
                        >
                          <VisibilityIcon />
                        </Link>
                      </TableCell>
...
export default TablePhanphatDen2;
